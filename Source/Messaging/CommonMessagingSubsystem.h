 ...
 */
UCLASS(config = Game)
class COMMONUIEXTENSION_API UCommonMessagingSubsystem : public ULocalPlayerSubsystem
{
	GENERATED_BODY()
...
public:
	...
	virtual void ShowOk(UCommonGameDialogDescriptor* DialogDescriptor, FCommonMessagingResultDelegate ResultCallback = FCommonMessagingResultDelegate());
